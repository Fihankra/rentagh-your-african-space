  ...
  head: () => ({
    meta: [
      { title: "About RentaGh: Every Space. One Platform." },
      {
        name: "description",
        content:
          "RentaGh is Ghana's premium all-in-one property platform, built for landlords, renters, agents and developers across the continent.",
      },
        ...
        <div className="grid gap-12 lg:grid-cols-[1.2fr_1fr]">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-foreground/80">
              RentaGh is a premium property marketplace combining the best of Airbnb, Booking.com,
              Property24 and Zillow, adapted for Ghanaian architecture, African landscapes and the
              way real estate actually moves on the continent. From a verified Cantonments villa to
              a registered cocoa farm in Ejisu, every space lives on one platform.
            </p>
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              ...
              <Link
                to="/contact"
                className="rounded-full border hairline bg-card px-6 py-3 text-sm font-semibold text-foreground"
              >
                List your property
              </Link>
            </div>
        ...
        <section className="mt-24">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            {[
              {
                t: "Verified always",
                d: "Every host and listing is reviewed by a real RentaGh team member before going live.",
              },
              {
                t: "Pay your way",
                d: "MTN MoMo, Telecel Cash, AirtelTigo Money, cards and bank transfers, with escrow protection.",
              },
              {
                t: "Premium, always",
                d: "Cinematic photography, calm typography and African-inspired craft on every screen.",
              },
            ].map((x) => (
