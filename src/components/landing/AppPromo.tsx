          ...
          <div className="grid md:grid-cols-2">
            <div className="p-10 md:p-14">
              <h2 className="mt-4 font-display text-4xl font-semibold text-balance md:text-5xl">
                RentaGh in your pocket.{" "}
                <span className="italic text-[color:var(--accent)]">Always.</span>
              </h2>
              <p className="mt-4 max-w-md text-white/70">
                Save searches, secure a hostel room, house or land, pay with Mobile Money, and chat
                with verified owners, anywhere in Ghana.
              </p>
              <ul className="mt-8 grid gap-3 text-sm text-white/80">
                <li className="flex items-center gap-3">
                  <ShieldCheck className="h-4 w-4 text-[color:var(--accent)]" /> Verified hosts &
                  properties
                </li>
                <li className="flex items-center gap-3">
                  <Wallet className="h-4 w-4 text-[color:var(--accent)]" /> MTN, Telecel &
                  AirtelTigo MoMo
                </li>
                <li className="flex items-center gap-3">
                  <Zap className="h-4 w-4 text-[color:var(--accent)]" /> Instant booking & offline
                  gallery
                </li>
              </ul>
